...
export default function ChildSelectPage() {
    ...
    return (
        <Box sx={{ minHeight: "100vh", background: "linear-gradient(135deg,#deeefe,#e8f4fd,#f0f6ff)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", py: 4, px: 2, position: "relative" }}>
            <AuthHeader />
            ...
            <Container maxWidth="sm">
                <AnimatedPage delay={100}>
                    <Box sx={{ backgroundColor: "#fff", borderRadius: 5, p: { xs: 3, md: 4 }, boxShadow: "0 8px 40px rgba(0,0,0,0.08)" }}>
                                    ...
                                    <Grid size={{ xs: 4, sm: 3 }} key={child._id}>
                                        <AnimatedItem index={i}>
                                            <Box onClick={() => handleSelect(child)} sx={{
                                                ...
                                                "&:hover": { backgroundColor: "#e8f4fd", transform: "scale(1.08) translateY(-4px)", boxShadow: "0 8px 24px rgba(58,181,230,0.15)" },
                                            }}>
                                                <Avatar sx={{ width: 64, height: 64, mx: "auto", mb: 1, fontSize: "2rem", backgroundColor: "#e0eeff", transition: "all 0.2s" }}>
                        ...
                        {!loading && children.length === 0 && !error && (
                            <Typography variant="body2" sx={{ textAlign: "center", color: "#888", py: 3 }}>
